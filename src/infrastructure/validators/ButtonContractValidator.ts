 ...
 */
export class ButtonContractValidator implements IButtonValidator {
  getName(): string {
   ...
   */
  private validateRequiredVariants(contract: ButtonContract, errors: string[], warnings: string[]): void {
   ...
   */
  private validateButtonProps(contract: ButtonContract, errors: string[], warnings: string[]): void {
   ...
   */
  private validateAccessibilityCompliance(contract: ButtonContract, errors: string[], warnings: string[]): void {
   ...
   */
  private validateVariantCombinations(contract: ButtonContract, errors: string[], warnings: string[]): void {
   ...
   */
  private validateBusinessRules(contract: ButtonContract, errors: string[], warnings: string[]): void {
